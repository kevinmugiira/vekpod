...
{{--                            @if(Auth()->user()->profiel_photo_url)--}}
{{--                                {--}}
{{--                                   <img src="{{Auth()->user()->profile_photo_path}}" alt="..." class="w-32 img-circle">--}}
{{--                                }else {--}}
...
{{--        <div id="top-search" class="btn-groups"><strong class="text-muted">Top searches:</strong>--}}
