                            ...
                            <div class="page-title m-b"><h1 class="inline m-a-0">Browse</h1>
                                <div class="dropdown inline">
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        @endforeach
{{--                                        <a href="#" class="dropdown-item">acoustic</a>--}}
{{--                                        <a href="#" class="dropdown-item">ambient</a>--}}
{{--                                        <a href="#" class="dropdown-item">blues</a>--}}
{{--                                        <a href="#" class="dropdown-item">classical</a>--}}
{{--                                        <a href="#" class="dropdown-item">country</a>--}}
{{--                                        <a href="#" class="dropdown-item">electronic</a>--}}
{{--                                        <a href="#" class="dropdown-item">emo</a>--}}
{{--                                        <a href="#" class="dropdown-item">folk</a>--}}
{{--                                        <a href="#" class="dropdown-item">hardcore</a>--}}
{{--                                        <a href="#" class="dropdown-item">hiphop</a>--}}
{{--                                        <a href="#" class="dropdown-item">indie</a>--}}
{{--                                        <a href="#" class="dropdown-item">jazz</a>--}}
{{--                                        <a href="#" class="dropdown-item">latin</a>--}}
{{--                                        <a href="#" class="dropdown-item">metal</a>--}}
{{--                                        <a href="#" class="dropdown-item">pop</a>--}}
{{--                                        <a href="#" class="dropdown-item">pop punk</a>--}}
{{--                                        <a href="#" class="dropdown-item">punk</a>--}}
{{--                                        <a href="#" class="dropdown-item">reggae</a>--}}
{{--                                        <a href="#" class="dropdown-item">rnb</a>--}}
{{--                                        <a href="#" class="dropdown-item">rock</a>--}}
{{--                                        <a href="#" class="dropdown-item">soul</a>--}}
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-3">
                                        <div class="item r" data-id="item-5" data-src="http://streaming.radionomy.com/JamendoLounge">
                                            <div class="item-media">
                                                <a href="{{url('track')}}" class="item-media-content" style="background-image: url('{{$episode->cover_image}}')"></a>
                                            ...
                                            <div class="item-info">
                                                ...
                                                <div class="item-title text-ellipsis">
                                                    <a href="{{url('track')}}">{{$episode->name}}</a>
                                                </div>
                                                <div class="item-author text-sm text-ellipsis">
                                                    <a href="{{url('track')}}" class="text-muted">{{$episode->author}}</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
{{--                                                        href="{{url('detail')}}" class="text-muted">Judith Garcia</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{--                                                <div class="item-author text-sm text-ellipsis"><a--}}
{{--                                                        href="{{url('detail')}}" class="text-muted">Jeremy Scott</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{--                                                    <div class="dropdown-menu pull-right black lt"></div>--}}
{{--                                                </div>--}}
{{--                                                <div class="item-title text-ellipsis"><a href="{{url('track')}}">All I--}}
{{--                                                        Need</a></div>--}}
{{--                                                <div class="item-author text-sm text-ellipsis"><a--}}
{{--                                                        href="{{url('detail')}}" class="text-muted">Pablo Nouvelle</a>--}}
{{--                                                </div>--}}
...
{{--                                                        Up</a></div>--}}
{{--                                                <div class="item-author text-sm text-ellipsis"><a--}}
{{--                                                        href="{{url('detail')}}" class="text-muted">Summerella</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
...
{{--                                                    <div class="dropdown-menu pull-right black lt"></div>--}}
{{--                                                </div>--}}
{{--                                                <div class="item-title text-ellipsis"><a href="{{url('track')}}">Body--}}
{{--                                                        on me</a></div>--}}
{{--                                                <div class="item-author text-sm text-ellipsis"><a--}}
...
{{--                                                        (Deluxe)</a></div>--}}
{{--                                                <div class="item-author text-sm text-ellipsis"><a--}}
{{--                                                        href="{{url('detail')}}" class="text-muted">Fifth Harmony</a>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                    </div>--}}
