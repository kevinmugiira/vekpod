                        ...
                        <div class="col-sm-6 text-white m-b-sm">
		                    ...
		                    ,animateOut:&#x27;fadeOut&#x27;
                                ...
                                <div class="item r" data-id="item-115"
                                    ...
                                    <div class="item-media primary"><a href="track.detail.html"
                                                                       class="item-media-content"
                                                                       style="background-image: url('{{asset('assets/images/c1.jpg')}}')"></a>
                                    ...
                                    <div class="item-info">
                                        ...
                                        <div class="item-title text-ellipsis"><a href="track.detail.html">New Album from
                                                Nouvelle</a></div>
                                        <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
                                                                                          class="text-muted">Nouvelle</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="item r" data-id="item-116"
                                    ...
                                    <div class="item-media info"><a href="track.detail.html" class="item-media-content"
                                                                    style="background-image: url('{{asset('assets/images/c2.jpg')}}')"></a>
                                        <div class="item-overlay center">
                                            <button class="btn-playpause">Play</button>
                                        </div>
                                    </div>
                                    <div class="item-info">
                                        ...
                                        <div class="item-title text-ellipsis"><a href="track.detail.html">Blind Me</a>
                                        </div>
                                        <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
                                                                                          class="text-muted">Fifty</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="item r" data-id="item-117"
                                    ...
                                    <div class="item-media accent"><a href="track.detail.html"
                                                                      class="item-media-content"
                                                                      style="background-image: url('{{asset('assets/images/c3.jpg')}}')"></a>
                                        <div class="item-overlay center">
                                            <button class="btn-playpause">Play</button>
                                        </div>
                                    </div>
                                    <div class="item-info">
                                        ...
                                        <div class="item-title text-ellipsis"><a href="track.detail.html">New Track from
                                                Pablo Nouvelle</a></div>
                                        <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="item r" data-id="item-1"
                                ...
                                <div class="item-info">
                                    ...
                                    <div class="item-title text-ellipsis"><a href="track.detail.html">Pull Up</a></div>
                                    <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
                        ...
                        <div class="col-sm-3 col-xs-6">
                            <div class="item r" data-id="item-3"
                                ...
                                <div class="item-info">
                                    ...
                                    <div class="item-title text-ellipsis"><a href="track.detail.html">I Wanna Be In the
                                            Cavalry</a></div>
                                    <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
				        ...
				        543:{
				            items: 3
                                ...
                                <div class="">
                                    <div class="item r" data-id="item-2"
                                         data-src="http://api.soundcloud.com/tracks/259445397/stream?client_id=a10d44d431ad52868f1bce6d36f5234c">
                                        <div class="item-media item-media-4by3"><a href="track.detail.html"
                                                                                   class="item-media-content"
                                                                                   style="background-image: url('{{asset('assets/images/b1.jpg')}}')"></a>
                                            <div class="item-overlay center">
                                                <button class="btn-playpause">Play</button>
                                ...
                                <div class="">
                                    <div class="item r" data-id="item-6"
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-title text-ellipsis"><a href="track.detail.html">Body on
                                                    me</a></div>
                                            <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
                                ...
                                <div class="">
                                    <div class="item r" data-id="item-3"
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-title text-ellipsis"><a href="track.detail.html">I Wanna Be
                                ...
                                <div class="">
                                    <div class="item r" data-id="item-9"
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-title text-ellipsis"><a href="track.detail.html">All I
                                                    Need</a></div>
                                            <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
                                                                                              class="text-muted">Pablo
                                                    Nouvelle</a></div>
                                ...
                                <div class="">
                                    <div class="item r" data-id="item-10"
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-title text-ellipsis"><a href="track.detail.html">The Open
                                                    Road</a></div>
                                            <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
                                ...
                                <div class="">
                                    <div class="item r" data-id="item-7"
                                        ...
                                        <div class="item-info">
                                            ...
                                            <div class="item-title text-ellipsis"><a href="track.detail.html">Reflection
                                                    (Deluxe)</a></div>
                                            <div class="item-author text-sm text-ellipsis"><a href="artist.detail.html"
                            ...
                            <div class="row">
                                            ...
                                            <div class="item r" data-id="item-7"
                                                ...
                                                <div class="item-info">
                                                    <div class="item-title text-ellipsis"><a href="track.detail.html">Reflection
                                                            (Deluxe)</a></div>
                                                    <div class="item-author text-sm text-ellipsis"><a
                                                            href="artist.detail.html" class="text-muted">Fifth
                                                            Harmony</a></div>
                                                    <div class="item-meta text-sm text-muted"></div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item r" data-id="item-5"
                                                ...
                                                <div class="item-info">
                                                    <div class="item-title text-ellipsis"><a href="track.detail.html">Live
                                                            Radio</a></div>
                                                    <div class="item-author text-sm text-ellipsis"><a
                                                            href="artist.detail.html" class="text-muted">Radionomy</a>
                                                    </div>
                                                    <div class="item-meta text-sm text-muted"></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="row item-list item-list-sm item-list-by m-b">
                                        <div class="col-xs-12">
                                            <div class="item">
                                                <div class="item-media rounded"><a href="artist.detail.html"
                                                                                   class="item-media-content"
                                                                                   style="background-image: url('{{asset('assets/images/a5.jpg')}}')"></a>
                                                </div>
                                                <div class="item-info">
                                                    <div class="item-title text-ellipsis"><a href="artist.detail.html">Judy
                                                            Woods</a>
                                        ...
                                        <div class="col-xs-12">
                                            <div class="item">
                                                ...
                                                <div class="item-info">
                                                    <div class="item-title text-ellipsis"><a href="artist.detail.html">Judith
                                                            Garcia</a>
                                        ...
                                        <div class="col-xs-12">
                                            <div class="item">
                                                ...
                                                <div class="item-info">
                                                    <div class="item-title text-ellipsis"><a href="artist.detail.html">Joe
                                                            Holmes</a>
                                        ...
                                        <div class="col-xs-12">
                                            <div class="item">
                                                ...
                                                <div class="item-info">
                                                    <div class="item-title text-ellipsis"><a href="artist.detail.html">Sara
                                                            King</a>
    ...
    <div id="share-modal" class="modal fade animate">
        <div class="modal-dialog">
            <div class="modal-content fade-down">
                <div class="modal-header"><h5 class="modal-title">Share</h5></div>
                <div class="modal-body p-lg">
                    <div id="share-list" class="m-b"><a href=""
                                                        class="btn btn-icon btn-social rounded btn-social-colored indigo"
                                                        title="Facebook"><i class="fa fa-facebook"></i> <i
                                class="fa fa-facebook"></i></a> <a href=""
                                                                   class="btn btn-icon btn-social rounded btn-social-colored light-blue"
                                                                   title="Twitter"><i class="fa fa-twitter"></i> <i
                                class="fa fa-twitter"></i></a> <a href=""
                                                                  class="btn btn-icon btn-social rounded btn-social-colored red-600"
                                                                  title="Google+"><i class="fa fa-google-plus"></i> <i
                                class="fa fa-google-plus"></i></a> <a href=""
                                                                      class="btn btn-icon btn-social rounded btn-social-colored blue-grey-600"
                                                                      title="Trumblr"><i class="fa fa-tumblr"></i> <i
                                class="fa fa-tumblr"></i></a> <a href=""
                                                                 class="btn btn-icon btn-social rounded btn-social-colored red-700"
                                                                 title="Pinterst"><i class="fa fa-pinterest"></i> <i
