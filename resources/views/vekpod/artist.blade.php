            ...
            <div class="page-content">
                <div class="row-col">
                    <div class="col-lg-9 b-r no-border-md">
                        <div class="padding">
                            <div class="page-title m-b"><h1 class="inline m-a-0">Artists</h1>
                                <div class="dropdown inline">
                                    <button class="btn btn-sm no-bg h4 m-y-0 v-b dropdown-toggle text-primary"
                                            data-toggle="dropdown">By name
                                    </button>
                                    <div class="dropdown-menu"><a href="#" class="dropdown-item active">By name</a> <a
                                            href="#" class="dropdown-item">Songs</a></div>
                                </div>
                            </div>
                                ...
                                <div class="row row-lg">
                                    <div class="col-xs-4 col-sm-4 col-md-3">
                                        <div class="item">
                                            <div class="item-media rounded"><a href="artist.detail.html"
                                                                               ...
                                                                               style="background-image: url('{{asset('assets/images/a6.jpg')}}')"></a>
                                            </div>
                                            <div class="item-info text-center">
                                                <div class="item-title text-ellipsis"><a href="artist.detail.html">OlsJesse
                                                        Russell</a>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-3">
                                        <div class="item">
                                            ...
                                            <div class="item-info text-center">
                                                <div class="item-title text-ellipsis"><a href="artist.detail.html">Richard
                                                        Carr</a>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-3">
                                        <div class="item">
                                            ...
                                            <div class="item-info text-center">
                                                <div class="item-title text-ellipsis"><a href="artist.detail.html">Jean
                                                        Schneider</a>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-3">
                                        <div class="item">
                                            ...
                                            <div class="item-info text-center">
                                                <div class="item-title text-ellipsis"><a href="artist.detail.html">Melissa
                                                        Garza</a>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-3">
                                        <div class="item">
                                            ...
                                            <div class="item-info text-center">
                                                <div class="item-title text-ellipsis"><a href="artist.detail.html">Crystal
                                                        Guerrero</a>
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-3">
                                        <div class="item">
                                            ...
                                            <div class="item-info text-center">
                                                <div class="item-title text-ellipsis"><a href="artist.detail.html">Jeremy
                                                        Scott</a>
                                                    <div class="text-sm text-muted">14 songs</div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="item r" data-id="item-6"
                                                ...
                                                <div class="item-info">
                                                    <div class="item-title text-ellipsis"><a href="track.detail.html">Body
                                                            on me</a></div>
                                                    <div class="item-author text-sm text-ellipsis"><a
                                                            href="artist.detail.html" class="text-muted">Rita Ora</a>
                                                    </div>
                                                    <div class="item-meta text-sm text-muted"></div>
                                                </div>
                                            </div>
