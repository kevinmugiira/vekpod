...
@section('content')
    ...
    <div data-flex-no-shrink>
        <div class="nav-fold dropup"><a data-toggle="dropdown"><span class="pull-left">
                    <img src="{{asset('assets/images/a3.jpg')}}"
                                                                                            alt="..."
            ...
            <div class="page-content">
                <div class="padding b-b">
                    <div class="row-col">
                        ...
                        <div class="col-sm">
                            <div class="p-l-md no-padding-xs"><h1 class="page-title"><span class="h1 _800">Rachel Platten</span>
                                </h1>
                                <p class="item-desc text-ellipsis text-muted" data-ui-toggle-class="text-ellipsis">Lorem
                                    ...
                                    concedamus.</p>
                                <div class="item-action m-b"><a href="#" class="btn btn-sm rounded primary">Upload</a>
                                    <a href="#" class="btn btn-sm rounded white">Edit Profile</a></div>
                                <div class="block clearfix m-b"><span>9</span> <span class="text-muted">Albums</span>,
                                    <span>23</span> <span class="text-muted">Tracks</span></div>
                            </div>
                        </div>
                    </div>
                </div>
                                            ...
                                            <div class="item r" data-id="item-7"
                                                ...
                                                <div class="item-info">
                                                    ...
                                                    <div class="item-meta text-sm text-muted"><span
                                                        ...
                                                        <span class="item-meta-date text-xs">05.05.2016</span></div>
                                ...
                                <div class="tab-pane" id="profile">
                                    <form>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-9"><input placeholder="http://" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-sm-3 form-control-label text-muted">Music Type</div>
                                            <div class="col-sm-9"><select class="form-control c-select">
                                                    <option>Blue</option>
